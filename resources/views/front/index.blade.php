        ...
        <div class="owl-carousel owl-banner">
            <div class="item item-1">
                <div class="header-text">
                    <span class="category">Eşsiz Deneyim</span>
                    <h2>Şehir Kalabalığından <br>Uzakta Bir Mola</h2>
                </div>
            </div>
            <div class="item item-2">
                <div class="header-text">
                    <span class="category">Rahatlığın Adresi</span>
                    <h2>Şıklık ve Konforun Bir Araya Geldiği Mekan</h2>
                </div>
            </div>
            <div class="item item-3">
                <div class="header-text">
                    <span class="category">Yepyeni Bir Macera</span>
                    <h2>Konforlu İhtişamın Eşsiz Birleşimi</h2>
                </div>
            </div>
        </div>
    </div>
